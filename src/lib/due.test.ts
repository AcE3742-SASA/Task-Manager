...
describe('snoozeDue — 하루 미루기', () => {
  ...
  it('오늘 마감은 같은 시각의 내일로 옮긴다', () => {
    // 8/20 아무 시각 → 8/21(금) 23:59
    expect(iso(snoozeDue(at('2026-08-20T05:00:00Z'), now))).toBe('2026-08-21T05:00:00.000Z')
  })
  ...
  it('기한이 없으면 임의의 날짜를 만들지 않는다', () => {
    expect(() => snoozeDue(null, now)).toThrow()
  })

  it('직접 정한 시각을 유지한다', () => {
    expect(iso(snoozeDue(at('2026-08-24T02:00:00Z'), now))).toBe('2026-08-25T02:00:00.000Z')
  })
